...
Two middleware functions are provided by default in the `comiclist.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `comiclist.handler` namespace to manage the enabled middleware.
